...
(function (root, factory) {
    ...
    function _initDraggable() {
        ...
        self.elements.overlay.addEventListener('mousedown', mouseDown, {passive: true});
        self.elements.viewport.addEventListener('keydown', keyDown, {passive: true});
        self.elements.overlay.addEventListener('touchstart', mouseDown, {passive: true});
    }
