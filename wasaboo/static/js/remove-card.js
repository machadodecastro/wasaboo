...
$( document ).ready(function() {
	...
	$(".discard").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-discard/"+card_id,
    	   async: true,
	...
	$(".harassment").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-harassment/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	...
	$(".spam").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-spam/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	            if (data.teste == "spam") {
	...
	$(".plagiarism").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-plagiarism/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	...
	$(".joke").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-joke/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	            if (data.teste == "joke") {
	...
	$(".out").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-out/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	            if (data.teste == "out") {
	...
	$(".written").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-written/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	...
	$(".fake").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-fake/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	            if (data.teste == "fake") {
	...
	$(".image").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-image/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
	            if (data.teste == "image") {
	...
	$(".incorrect").on('click',function(){ 
    	...
    	$.ajax({
    	   ...
    	   dataType: 'json', 
    	   data: {card: card_id},
    	   url: "http://"+wasabooref+"/remove-by-incorrect/"+card_id,
    	   async: true,
    	   contentType: "application/json; charset=utf-8",
    	   success: function (data, textStatus, jqXHR) {
