...
(function($){
	$.fn.textareaCompanyCounter = function(options) {
		...
		return this.each(function() {
			...
			obj = $(this);
			obj.after('<span style="color: #ccc; font-size: 11px; clear: both; margin-top: 3px; display: block;" class="counter-company">Max. '+options.limit+' words</span>');
...
$(".company_content_counter").textareaCompanyCounter();
